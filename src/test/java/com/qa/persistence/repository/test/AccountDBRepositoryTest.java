...
public class AccountDBRepositoryTest {
	...
	private static final String MOCK_DATA_ARRAY = "[{\"firstName\":\"John\",\"secondName\":\"Doe\",\"accountNumber\":\"111111\"}]";

	private static final String MOCK_OBJECT = "{\"firstName\":\"John\",\"secondName\":\"Doe\",\"accountNumber\":\"111111\"}";
	...
	public void testGetAllAccounts() {
		...
		accounts.add(new Account("John", "Doe", "111111", null));
